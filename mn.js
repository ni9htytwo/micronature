...
(function () {
  ...
  if (buttons.length) {
    ...
    lb.innerHTML =
      ...
      '<button class="lb-close" type="button">关闭 ESC</button></div>' +
  ...
  var GLOSSARY = {
    ...
    'redblue': ['红蓝对抗', '借自网络安全渗透测试：主动构造会让系统出错的场景，而不是等它在现场出错。'],
  ...
  function describe(el) {
    if (el.classList.contains('term')) {
      ...
      return g ? { k: '释义', t: g[0], d: g[1] } : null;
    }
  ...
  /* 6. Arriving somewhere by reference should say so: flash the target. */
  function flash(id) {
